...
async function fetchData() {
    const { data } = await axios.get('https://631b4048fae3df4dcff94f47.mockapi.io/api/todoItems')
    return data
}
...
$("#my-form").addEventListener('submit', async function(e){
    ...
    const res = await axios.post('https://631b4048fae3df4dcff94f47.mockapi.io/api/todoItems', data)
